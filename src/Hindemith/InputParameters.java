...
import Hindemith.RhythmModule.CommonTimeSuperStraightPatternGenerator;
...
static Integer [] consonances = {0, 3, 4, 5, 7, 8, 9, 10, 11};
static Integer [] perfect_consonances = {0, 5, 7};
static Integer [] root_consonances = {0, 3, 4, 7, 10, 11};
static int tempo_bpm = 150;
static int piece_length = 1;
static int root_key = 0;
static ModeModule my_mode_module = new Clydian_keyChange();
static String [] voice_array = {"bass", "bass", "bass", "bass", "bass", "bass"};  
...
static int [] transpose_interval_array = {0,2,2,2,2,2};//9,4,7 is good
static int sample_size = 3; //reduce?
static byte [] instbyte = { 46, 46, 46, 46, 46, 46};
...
public static void setJames(String generator_string){
    ...
    if (generator_string.contains("Variable Time Signature Unfunky") )
        james = new CommonTimeSuperStraightPatternGenerator();
